#include "DHT.h" //Biblioteca para uso do sensor DTH11
#include <EEPROM.h> // Biblioteca para acesso e manipulação da EEPROM
#include <SoftwareSerial.h> //Biblioteca para selecionar a porta serial utilizada
#include <TimeLib.h> //Biblioteca utilizada para setar a data das coletas dos dados
